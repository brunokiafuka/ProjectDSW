 ...
 $stmt->execute();
		...
		while( $result = $stmt->fetch(PDO::FETCH_OBJ))
		{
			...
			echo "
                       ...
                       <form action='actor_result.php' method='post' enctype='multipart/form-data' style='padding:80px;'>
			...
			<tr>
			   ...
			   <td><input type='text' name='new_actor_name' size='60' value='$actor_name' required></td>
			</tr>
			<tr>
			   <td align='right'><b>Actor Age:</b></td>
			   <td><input type='text' name='new_actor_age' size='60' value='$actor_age' required></td>
			</tr>
			<tr>
			   <td align='right'><b>Actor Number of Movies:</b></td>
			   <td><input type='text' name='new_actor_movies' size='60' value='$actor_movies' required></td>
			</tr>
			<tr>
			    <td align='right'><b>Actor Image:</b></td>
			    <td><input type='file' name='new_actor_image' required /><img src='actor_images/$actor_image' style='width:60px; height:60px;'></td>
			</tr>
...
move_uploaded_file($actor_image_tmp ,"actor_images/$actor_image");
		...
		if($stmt)
		{
			...
			echo "<script>window.open('actor_result.php','_self')</script>";
		}
	}

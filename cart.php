...
<html>
	...
	<body>
		...
		<section class="login-sec cart-sec">
			...
			<div class="totalAmountPay">
				<h2 class="t-pay">Total: R<span class="total-cart">0</span></h2>
				<a href="cart-checkout.php"><button class="cartButton">Check out</button></a>				
				<button class="cartButton" onclick="javascript:history.back();">Continue shopping</button>
			</div>
